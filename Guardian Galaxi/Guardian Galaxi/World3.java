...
public class World3 extends World
{
    ...
    public void prepare()
    {
        ...
        EnemyR enr2 = new EnemyR();
        addObject(enr2, 200, 255);
        ...
        EnemyL enl3 = new EnemyL();
        addObject(enl3, 300, 135);
        EnemyL enl4 = new EnemyL();
        addObject(enl4, 500, 375);
    }
}
